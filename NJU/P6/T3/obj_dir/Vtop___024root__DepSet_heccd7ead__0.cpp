...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Init
    QData/*63:0*/ __Vdly__top__DOT__state;
    __Vdly__top__DOT__state = 0;
    // Body
    __Vdly__top__DOT__state = vlSelf->top__DOT__state;
    __Vdly__top__DOT__state = ((IData)(vlSelf->load)
                                ? vlSelf->in : ((vlSelf->top__DOT__state 
                                                 << 1U) 
                                                | (QData)((IData)(
                                                                  (1U 
                                                                   & VL_REDXOR_8(
                                                                                (0x1dULL 
                                                                                & vlSelf->top__DOT__state)))))));
    vlSelf->out = vlSelf->top__DOT__state;

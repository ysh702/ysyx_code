...
VL_INLINE_OPT void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelf->out = ((IData)(vlSelf->lr) ? (vlSelf->in 
                                          << (IData)(vlSelf->shift))
                    : ((IData)(vlSelf->al) ? VL_SHIFTRS_III(32,32,5, vlSelf->in, (IData)(vlSelf->shift))
                        : (vlSelf->in >> (IData)(vlSelf->shift))));
}
...
void Vtop___024root___eval_debug_assertions(Vtop___024root* vlSelf) {
    ...
    // Body
    if (VL_UNLIKELY((vlSelf->shift & 0xe0U))) {

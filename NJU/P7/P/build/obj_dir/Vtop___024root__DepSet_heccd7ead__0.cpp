...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    CData/*3:0*/ __Vdly__top__DOT__shift_key_count;
    __Vdly__top__DOT__shift_key_count = 0;
    CData/*3:0*/ __Vdly__top__DOT__ctrl_key_count;
    __Vdly__top__DOT__ctrl_key_count = 0;
    CData/*3:0*/ __Vdly__top__DOT__CapsLock_key_count;
    __Vdly__top__DOT__CapsLock_key_count = 0;
    ...
    __Vdly__top__DOT__CapsLock_key_count = vlSelf->top__DOT__CapsLock_key_count;
    __Vdly__top__DOT__ctrl_key_count = vlSelf->top__DOT__ctrl_key_count;
    __Vdly__top__DOT__shift_key_count = vlSelf->top__DOT__shift_key_count;
    ...
    if (vlSelf->clrn) {
        ...
        __Vdly__top__DOT__shift_key_count = 0U;
        __Vdly__top__DOT__ctrl_key_count = 0U;
        vlSelf->top__DOT__shift_flag = 0U;
        vlSelf->top__DOT__ctrl_flag = 0U;
        __Vdly__top__DOT__CapsLock_key_count = 0U;
        vlSelf->top__DOT__CapsLock_flag = 0U;
    } else {
        ...
        if ((IData)((4U == (6U & (IData)(vlSelf->top__DOT__my_keyboard__DOT__ps2_clk_sync))))) {
            if ((0xaU == (IData)(vlSelf->top__DOT__my_keyboard__DOT__count))) {
                if (VL_UNLIKELY((((~ (IData)(vlSelf->top__DOT__my_keyboard__DOT__buffer)) 
                    ...
                    if (VL_UNLIKELY((0x12U == (0xffU 
                                               & ((IData)(vlSelf->top__DOT__my_keyboard__DOT__buffer) 
                                                  >> 1U))))) {
                        __Vdly__top__DOT__shift_key_count 
                            = (0xfU & ((IData)(1U) 
                                       + (IData)(vlSelf->top__DOT__shift_key_count)));
                        VL_WRITEF("shift+1\nshift:%x\n",
                                  4,vlSelf->top__DOT__shift_key_count);
                    }
                    ...
                    if (VL_UNLIKELY((0x14U == (0xffU 
                                               & ((IData)(vlSelf->top__DOT__my_keyboard__DOT__buffer) 
                                                  >> 1U))))) {
                        __Vdly__top__DOT__ctrl_key_count 
                            = (0xfU & ((IData)(1U) 
                                       + (IData)(vlSelf->top__DOT__ctrl_key_count)));
                        VL_WRITEF("ctrl+1\nctrl:%x\n",
                                  4,vlSelf->top__DOT__ctrl_key_count);
                    }
                    ...
                    if (VL_UNLIKELY((0x58U == (0xffU 
                                               & ((IData)(vlSelf->top__DOT__my_keyboard__DOT__buffer) 
                                                  >> 1U))))) {
                        __Vdly__top__DOT__CapsLock_key_count 
                            = (0xfU & ((IData)(1U) 
                                       + (IData)(vlSelf->top__DOT__CapsLock_key_count)));
                        VL_WRITEF("CapsLock_key_count+1\nCapsLock_key_count:%x\n",
                                  4,vlSelf->top__DOT__CapsLock_key_count);
                    }
                    VL_WRITEF("receive %x\nshift:%x\nctrl:%x\nCapsLock_key_count:%x\n",
                              8,(0xffU & ((IData)(vlSelf->top__DOT__my_keyboard__DOT__buffer) 
                                          >> 1U)),4,
                              (IData)(vlSelf->top__DOT__shift_key_count),
                              4,vlSelf->top__DOT__ctrl_key_count,
                              4,(IData)(vlSelf->top__DOT__CapsLock_key_count));
                }
                __Vdly__top__DOT__my_keyboard__DOT__count = 0U;
            } else {
        ...
        if ((7U < (IData)(vlSelf->top__DOT__shift_key_count))) {
            __Vdly__top__DOT__shift_key_count = 0U;
        }
        if ((7U < (IData)(vlSelf->top__DOT__ctrl_key_count))) {
            __Vdly__top__DOT__ctrl_key_count = 0U;
        }
        if ((7U < (IData)(vlSelf->top__DOT__CapsLock_key_count))) {
            __Vdly__top__DOT__CapsLock_key_count = 0U;
        }
        if ((((0U == (IData)(vlSelf->top__DOT__shift_key_count)) 
              | ((1U == (IData)(vlSelf->top__DOT__shift_key_count)) 
                 | (4U == (IData)(vlSelf->top__DOT__shift_key_count)))) 
             | (5U == (IData)(vlSelf->top__DOT__shift_key_count)))) {
            vlSelf->top__DOT__shift_flag = 0U;
        } else if (((((2U == (IData)(vlSelf->top__DOT__shift_key_count)) 
                      | (3U == (IData)(vlSelf->top__DOT__shift_key_count))) 
                     | (6U == (IData)(vlSelf->top__DOT__shift_key_count))) 
                    | (7U == (IData)(vlSelf->top__DOT__shift_key_count)))) {
            vlSelf->top__DOT__shift_flag = 1U;
        }
        if (((((0U == (IData)(vlSelf->top__DOT__ctrl_key_count)) 
               | (1U == (IData)(vlSelf->top__DOT__ctrl_key_count))) 
              | (4U == (IData)(vlSelf->top__DOT__ctrl_key_count))) 
             | (5U == (IData)(vlSelf->top__DOT__ctrl_key_count)))) {
            vlSelf->top__DOT__ctrl_flag = 0U;
        } else if (((((2U == (IData)(vlSelf->top__DOT__ctrl_key_count)) 
                      | (3U == (IData)(vlSelf->top__DOT__ctrl_key_count))) 
                     | (6U == (IData)(vlSelf->top__DOT__ctrl_key_count))) 
                    | (7U == (IData)(vlSelf->top__DOT__ctrl_key_count)))) {
            vlSelf->top__DOT__ctrl_flag = 1U;
        }
        if (((((0U == (IData)(vlSelf->top__DOT__CapsLock_key_count)) 
               | (1U == (IData)(vlSelf->top__DOT__CapsLock_key_count))) 
              | (4U == (IData)(vlSelf->top__DOT__CapsLock_key_count))) 
             | (5U == (IData)(vlSelf->top__DOT__CapsLock_key_count)))) {
            vlSelf->top__DOT__CapsLock_flag = 0U;
        } else if (((((2U == (IData)(vlSelf->top__DOT__CapsLock_key_count)) 
                      | (3U == (IData)(vlSelf->top__DOT__CapsLock_key_count))) 
                     | (6U == (IData)(vlSelf->top__DOT__CapsLock_key_count))) 
                    | (7U == (IData)(vlSelf->top__DOT__CapsLock_key_count)))) {
            vlSelf->top__DOT__CapsLock_flag = 1U;
        }
    }
    ...
    vlSelf->top__DOT__shift_key_count = __Vdly__top__DOT__shift_key_count;
    vlSelf->top__DOT__ctrl_key_count = __Vdly__top__DOT__ctrl_key_count;
    vlSelf->top__DOT__CapsLock_key_count = __Vdly__top__DOT__CapsLock_key_count;
    vlSelf->top__DOT__my_keyboard__DOT__ps2_clk_sync 
        = __Vdly__top__DOT__my_keyboard__DOT__ps2_clk_sync;
...
#endif
                    VL_FATAL_MT("/home/ysh/ysyx-workbench/NJU/P7/P/vsrc/top.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/ysh/ysyx-workbench/NJU/P7/P/vsrc/top.v", 1, "", "NBA region did not converge.");
            }

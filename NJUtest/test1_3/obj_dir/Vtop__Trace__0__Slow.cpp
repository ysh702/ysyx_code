...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelf->F));
    bufp->fullCData(oldp+2,(vlSelf->Y),2);
    bufp->fullBit(oldp+3,(vlSelf->X0));
    bufp->fullBit(oldp+4,(vlSelf->X1));
    bufp->fullBit(oldp+5,(vlSelf->X2));
    bufp->fullBit(oldp+6,(vlSelf->X3));
}

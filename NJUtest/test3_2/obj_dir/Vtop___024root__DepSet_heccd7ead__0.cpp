...
VL_INLINE_OPT void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Init
    CData/*0:0*/ top__DOT____VdfgTmp_h36175ebf__0;
    top__DOT____VdfgTmp_h36175ebf__0 = 0;
    // Body
    top__DOT____VdfgTmp_h36175ebf__0 = ((IData)(vlSelf->a) 
                                        ^ (IData)(vlSelf->b));
    vlSelf->so = ((IData)(top__DOT____VdfgTmp_h36175ebf__0) 
                  ^ (IData)(vlSelf->ci));
    vlSelf->co = (((IData)(vlSelf->a) & (IData)(vlSelf->b)) 
                  | ((IData)(vlSelf->ci) & (IData)(top__DOT____VdfgTmp_h36175ebf__0)));
}
